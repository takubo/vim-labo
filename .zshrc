...
%%%f '
		PROMPT=$'%U\e[38;5;009m[%j] %(10L.X.%L) %w %D{%H:%M} \e[38;5;009m%n%u %U\e[38;5;075m%~%u\e[38;5;009m
%%%f '
		PROMPT=$'%U\e[38;5;009m[%j] (%L) %D{%m/%d(%a) %H:%M:%S} \e[38;5;009m%n%u %U\e[38;5;075m%~%u\e[38;5;009m
%%%f '
		;;
	* )
...
%%%{${reset_color}%} "
		PROMPT="%U%F{009}[%j] %(10L.X.%L) %w %D{%H:%M} %n%u %U%F{075}%~%u%F{009}
%%%f "
		PROMPT="%U%F{009}[%j] (%L) %D{%m/%d(%a) %H:%M:%S} %n%u %U%F{075}%~%u%F{009}
%%%f "
		;;
esac
...
alias ls='ls --color=auto --time-style=long-iso -h -v'
alias ls="ls --color=auto --time-style='+%Y/%m/%d(%a) %H:%M:%S' -h -v"
alias ll='ls -l'
alias la='ls -a'
alias lla='ls -la'
alias llh='ls -lh'
